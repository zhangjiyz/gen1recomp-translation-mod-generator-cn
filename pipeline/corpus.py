...
_LANG_RE = re.compile(r"(?:^|[-_.])(en|eng|fr|fra|french|english|de|deu|german|es|spa|spanish|it|ita|italian|ja|ja-hrkt|jpn|japanese|ko|kor|korean|zh|zh-hans|zho|chi|chinese)(?:$|[-_.])", re.I)
...
def canonical_language(value: Any, default: str = "en") -> str:
    ...
    if value in {"zh", "zh-cn", "zh_cn", "zh-hans", "zh_hans", "zho", "chi", "chinese", "simplified chinese", "简体中文", "中文"}: return "zh-Hans"
